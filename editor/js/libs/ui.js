...
UI.Element.prototype.save = function (callback) {
    this.save.call(callback.bind(this));
    return this;
};
...
UI.LinkButton = function (text, urlorfn) {
    ...
    if (urlorfn) {
        var _type = typeof urlorfn;

        if (_type === "function") {
            this.dom.onclick = urlorfn;
            this.dom.setAttribute("href", 'javascript:void(0)');
        } else if (_type === "string") {
            this.dom.setAttribute("href", urlorfn);
        }
    }
...
UI.LinkButton.prototype = Object.create(UI.Element.prototype);
UI.LinkButton.prototype.constructor = UI.LinkButton;
