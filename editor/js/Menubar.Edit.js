...
Menubar.Edit = function (editor) {
    ...
    option.onClick(function () {
        ...
        if (object.parent === null) return; // 避免克隆相机或场景
    ...
    option.onClick(function () {
        ...
        if (parent === undefined) return; // 避免删除相机或场景
